...
*These are the features required for the application to deliver core value.*
...
- [ ] Design and implement SQLite schema (telemetry, anomaly_events tables)
- [ ] Implement CentralServer class with shared ModelLoader
- [ ] Wire CentralServer into api.py alongside edge inference
- [ ] Add GET /central/status REST endpoint

**Week 11 — Comparison Panel & Integration Testing**
- [ ] Build comparison panel in frontend (latency delta, bandwidth ratio)
- [ ] Full system integration testing under 3-node load
